...
（全部 yellow 级，保证三步链退出码为 0），详见 SPEC.md 的播种表 V1~V10。
R2 变更：新增 V10 幽灵供应商行（null_match distinct 语义判别）。
"""
...
# 采购行（8 干净 + 2 行 V2 范围违规 + 1 行 V4b 必填违规 + 1 行 V10 幽灵供应商）
_PURCHASE = [
    ...
    ("",            "2026-08-12", "S02", "PC003", "GY003", "30",   "3.05"),   # V4b 必填违规（摄取层剔行）
    ("PO-2608-007", "2026-08-16", "S02", "FP001", "SUP-999", "25", "3.40"),   # V10 幽灵供应商（null_match distinct 第二个值）
]
