...
select
    ...
    case when entry_type = '销售' then quantity else 0 end as "sales_qty",
    case when entry_type = '销售' then 1 else 0 end as "sales_flag",
